...
public class FaceSystem : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        cheatCodes = player.GetComponent<CheatCodes>();
    }
    ...
    private void OnGUI()
    {
        ...
        GUI.DrawTexture(new Rect(350, 800, 150, 150), imgs[pick]);   // display the images
    }
}
